...
class MCSConnectInitial:
    ...
    def __init__(self, encryption_method):
        ...
        pdu += b'\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x0c\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\xca\x01\x00\x00\x00\x00'
        pdu += b'\x00\x18\x00\x07\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x00\x00\x00\x00\x00\x04\xc0\x0c\x00\x09\x00\x00\x00\x00\x00\x00\x00'
        pdu += b'\x02\xc0\x0c\x00'
        
        # insert encryption type into the PDU
        pdu += struct.pack('<B', encryption_method)
        
        pdu += b'\x00\x00\x00\x00\x00\x00\x00\x03\xc0\x20\x00\x02'
...
class MCSConnectResponse:#response to MCS connection
    ...
    def __init__(self, resp):
        ...
        self.decoded_resp = decoder.decode(resp)[1]
        # self.decoded_resp
        try:
...
def helper_parse(subparser):
    parser_task1 = subparser.add_parser("8", help="Terminal Services Misconfigurations")
...
def solve(args):
    ...
    scan: GroupNessusScanOutput = find_scan(args.file, 8)
    if not scan: 
